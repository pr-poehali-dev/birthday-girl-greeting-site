...
/* ─── WISHES DATA ─── */
const WISHES = [
  { from: "Мама", text: "Солнышко моё, с днём рождения! Пусть каждый день будет полон радости и улыбок!", emoji: "🌸", color: "#FF2D78" },
  { from: "Папа", text: "С праздником! Ты лучшее, что есть в нашей жизни. Расти большим и счастливым!", emoji: "⭐", color: "#FF6B00" },
  { from: "Друзья", text: "Ты самый классный! Желаем приключений, смеха и незабываемых моментов!", emoji: "🚀", color: "#00E5FF" },
  { from: "Бабушка", text: "Деточка, здоровья тебе, счастья и всего самого лучшего на свете!", emoji: "💝", color: "#BF00FF" },
  { from: "Дедушка", text: "С днём рождения! Пусть мечты сбываются, а желания исполняются!", emoji: "🌟", color: "#00FF88" },
